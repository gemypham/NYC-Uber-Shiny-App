...
We want to investigate how Uber is performing in New York City (NYC). More specifically we wanted to look at: 
How has Uber changed the dynamics of NYC for-hire-vehicle service?
 
With an outset in the Kaggle dataset, we want to explore and visualize the data to provide an answer to this question.Overall, it is evident that most pickups occur in Manhattan for both Uber and Lyft. However there are some indications that a significant number of pickups also occur in at least a few other Boroughs.
